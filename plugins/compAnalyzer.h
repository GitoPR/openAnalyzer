...
#ifndef compAnalyzer_H
#define compAnalyzer_H
...
class compAnalyzer : public edm::one::EDAnalyzer<edm::one::SharedResources> {
public:
  explicit compAnalyzer(const edm::ParameterSet&);
  ~compAnalyzer() override;
...
private:
  ...
  // The Comparison Branches of the TTree
  TH1F* regionCompEta;
  TH1F* regionCompPhi;
  TH1F* regionCompEt;
  TH1F* regionHitEta;
